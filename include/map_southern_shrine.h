...
// Map Dimensions
const int cnSouthernShrineMapWidth   = 38;
const int cnSouthernShrineMapHeight  = 24;

// Map Layout
int nSouthernShrineMapArray[cnSouthernShrineMapHeight][cnSouthernShrineMapWidth] = {
...
const int cnSouthernShrineChests = 2;
// fields corespond to:
// 0 = nItemType
// 1 = nGoldMin
// 2 = nGoldMax
...
int nSouthernShrineChestList[cnSouthernShrineChests][cnChestAttributes] = {
	{ cnItemNone,  0,  0,  0, 0 },
	{ cnItemRainbowDrop, 0, 0, 12, 19 }
};

const int cnSouthernShrineActors = 0;
// values corespond to:
...
int nSouthernShrineActorList[cnSouthernShrineActors][cnBasicActorAttributes] = {
};
